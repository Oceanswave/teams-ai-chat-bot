...
const dreamCommandHandler_1 = require("../dreamCommandHandler");
...
exports.commandBot = new ConversationBot({
    ...
    command: {
        enabled: true,
        commands: [new gptCommandHandler_1.GptCommandHandler(), new sayItCommandHandler_1.SayItCommandHandler(), new dreamCommandHandler_1.DreamCommandHandler()],
    },
});
